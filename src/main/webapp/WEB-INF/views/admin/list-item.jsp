				...
				<tbody>
					<c:forEach items="${pList}" var="o">
						<tr>
							...
							<td><img alt="pd" src="../images/${o.imgIcon}" width="100px"></td>
							<td>${o.name }</td>
							<td>${o.sku }</td>
							<td>${o.material }</td>
							<td>${o.category }</td>
							<td>${o.currencyFormat(o.price) }</td>
							<td>${o.number }</td>
							<td>
								<a href="${base}/load-edit?id=${o.id}">
									<i class="fas fa-edit"></i></a> 
								<a href="${base }/delete-item?id=${o.id}" style="color: red">
