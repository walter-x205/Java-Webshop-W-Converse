...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
		...
		<c:if test="${sessionScope.admin != null }">
			<sf:form action="${base }/add-item" modelAttribute="addItem">
				<div>
					<h1>Thêm sản phẩm</h1>
				</div>
				<div>
				...
				<div class="form-group">
					...
					<sf:input type="text" class="form-control" id="sku"
						placeholder="VD: 000000C" path="sku"></sf:input>
				</div>
				<div class="form-group">
					<label for="formGroupExampleInput2">Chất liệu</label>
					<sf:input type="text" class="form-control" id="material"
				...
				<div class="form-group">
					...
					<sf:input type="text" class="form-control" id="price"
						placeholder="VD: 5000000" path="price"></sf:input>
				</div>
				<div class="form-group">
					<label for="formGroupExampleInput2">Số lượng nhập</label>
					<sf:input type="text" class="form-control" id="number"
						placeholder="VD: 100" path="number"></sf:input>
				</div>
				<button type="button" class="btn btn-primary"
					onClick="addItem('${base}');">Thêm</button>
